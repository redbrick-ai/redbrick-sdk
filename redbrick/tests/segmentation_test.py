...
def test_init_empty() -> None:
    ...
    # arrange
    image_segment = ImageSegmentation(classes=classes1, remote_labels=remote_label1)
...
def test_init_basic() -> None:
    ...
    # arrange
    image_segment = ImageSegmentation(classes=classes1, remote_labels=remote_label2)
...
def test_init_two_obj() -> None:
    ...
    # arrange
    image_segment = ImageSegmentation(classes=classes1, remote_labels=remote_label3)
...
def test_init_single_hole() -> None:
    ...
    """
    # arrange
    image_segment = ImageSegmentation(classes=classes1, remote_labels=remote_label4)
...
def test_init_reg_inside_hole() -> None:
    ...
    # arrange
    image_segment = ImageSegmentation(classes=classes1, remote_labels=remote_label5)
